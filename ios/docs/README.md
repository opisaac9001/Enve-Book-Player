...
Start with the root [architecture guide](../ARCHITECTURE.md) for targets, source ownership, dependency direction, and file placement.
...
- [Design language](ui/DESIGN.md)
- [Feature parity](ui/PARITY.md)
